package com.yihukurama.app.scanticketdemo.framework.v;
...
import com.yihukurama.app.scanticketdemo.opensource.zxing.camera.WindowManagerHelper;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			Toast.makeText(CaptureActivity.this, "码值是"+resultString, Toast.LENGTH_SHORT).show();
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int width,
		...
		int x = WindowManagerHelper.getDisplayWidth(this);
		int y = WindowManagerHelper.getDisplayHeight(this);
		surfaceView.setLayoutParams(new FrameLayout.LayoutParams(x, y));//因为我layout布局是用FrameLayout
